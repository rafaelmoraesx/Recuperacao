...
CREATE TABLE `maquina` (
  ...
  CONSTRAINT `maquina_ibfk_1` FOREIGN KEY (`laboratorio_id`) REFERENCES `laboratorio` (`id`)
...
INSERT INTO `maquina` VALUES (3,'NOTEBOOK','256gb 12gb RAM','ATIVO',1),(4,'PC DE TRABALHO','RYZEN 6 500gb','EM MANUTENÇÃO',2),(6,'pc edição','hd mecanico','manutenção',2),(7,'lllalalala','lalalala','ativo',2);
