...
CREATE TABLE `peca` (
  ...
  CONSTRAINT `peca_ibfk_1` FOREIGN KEY (`laboratorio_id`) REFERENCES `laboratorio` (`id`)
...
INSERT INTO `peca` VALUES (1,'MEMORIA','DDR4',2,1),(3,'TECLADO','USB',4,2),(5,'teste','teste',3,1),(6,'aaaa','aaaaa',5,1),(7,'testando','testar',9,5);
...
-- Dump completed on 2025-12-15 19:32:02
